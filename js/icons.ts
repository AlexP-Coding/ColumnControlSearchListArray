...
const icons = {
	...
	orderAddAsc: wrap('<path d="M 7,20 V 12" /><path d="M 11,16 H 3" /><path d="m 14,4 h 7" /><path d="M 11,8 H 21" /><path d="M 11,12 H 21" />'),

	// Custom icon, not part of Lucide
	orderAddDesc: wrap('<path d="M 7,20 V 12" /><path d="M 11,16 H 3" /><path d="M 7,4 H 21" /><path d="M 11,8 H 21" /><path d="m 15,12 h 6" />'),
